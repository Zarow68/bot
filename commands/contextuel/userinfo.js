...
module.exports = {
    ...
    async runInteraction (client, interaction) {
        ...
        .setAuthor({ name: `${member.user.tag} (${member.id})`, iconURL: member.user.bot ? 'https://images.emojiterra.com/twitter/v14.0/512px/1f916.png' : 'https://images.emojiterra.com/twitter/v14.0/512px/1f9d1.png' })
        .setColor('#8e48f7')
